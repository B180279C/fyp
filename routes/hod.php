...
Route::post($character.'/report/TP/searchCourse/','Dean\ReportTPController@searchCourse')->name('hod.report.tp');
...
Route::post($character.'/report/CA/searchCourse/','Dean\ReportAssessmentController@searchCourse')->name('hod.report.ca');
...
Route::post($character.'/report/FA/searchCourse/','Dean\ReportFinalAssessmentController@searchCourse')->name('hod.report.fa');
...
Route::post($character.'/E_Portfolio/searchCourse/', 'Dean\E_PortfolioController@searchCourse')->name('hod.report.e_p');
Route::get($character.'/E_Portfolio/download/zipFiles/{course_id}/{checked}','Dean\E_PortfolioController@downloadZipFiles');
?>