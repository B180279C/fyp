...
<!--                <hr style="margin: 0px;background-color: #0d2f81;"> -->
                    ...
                    <table id="sidebar-table" style="background-color: #e5e7e8; border:none;width: 100.1%;padding:0px;margin: 0px; position: absolute; bottom: 0px;">
                        <tr>
                            ...
                            <td id="sidebar-img">
                                <center>
                                    <img src="{{ action('HomeController@studentDetails', Auth::user()->user_id ) }}" height="50px;" style="border-radius: 50%; border:2px solid white;margin-left: auto;margin-right: auto;width: 60%;" id="myImage">        
                                </center>
                            </td>
                            <?php
                            ...
                            <td>
                                ...
                                <p id="slidebar-details" style="color: grey"><b>Student</b></p>
                            </td>
                        <tr>
                    </table>
            </div>
