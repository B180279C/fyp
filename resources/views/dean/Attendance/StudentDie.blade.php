                ...
                <div class="col-md-8 align-self-center">
                    ...
                    <center><h5 style="color: #0d2f81"></h5></center>
                        ...
                        <div style="border:0px solid black;text-align: center;">
                            <img src="{{url('image/die.png')}}" width="150px" height="150px">
                            <p style="font-size: 22px;">This QR Code is already <span style="color: red;font-weight: bold;">Die</span>. <br/><span style="font-size: 18px;">Please talk your Lecturer to help you to take your attendance.</span></p>
                        </div>
                    <br>
                </div>
        </div>
