  ...
  $(document).ready(function(){
    ...
    $.ajaxSetup({
      headers: {
        ...
        $.ajax({
            type:'POST',
            url:'/Dean/FinalExamination/getSyllabusData',
            ...
            success:function(response){
              ...
              cell1.innerHTML = '<a href="/Dean/FinalExamination/question/'+percentage+'/'+course_id+'/" style="font-size:18px;width:100%;display:block;" class="question_link"><i class="fa fa-plus" aria-hidden="true" ></i></a>';
              if(status==true){
              ...
              cell1.innerHTML = '<a href="/Dean/FinalResult/'+course_id+'/" style="font-size:18px;width:100%;display:block;" class="question_link"><i class="fa fa-plus" aria-hidden="true" ></i></a>';
