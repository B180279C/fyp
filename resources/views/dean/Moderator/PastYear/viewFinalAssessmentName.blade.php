...
function w3_close() {
  ...
  $(document).ready(function(){
    ...
    $(document).on('click', '.download_button', function(){
      ...
      var num = id.split("_");
      var original_id = $('#original_id').val();
      window.location = "{{$character}}/Moderator/PastYear/FinalAssessment/download/"+original_id+"-"+num[2];
    });
  });
  ...
  $(function () {
        ...
        if($('.search').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url: "{{$character}}/Moderator/PastYear/FinalAssessment/name/searchAssessmentName/",
                ...
                <div id="action_sidebar" class="w3-animate-right" style="display: none">
                  ...
                  <ul class="sidebar-action-ul">
                      ...
                      <input type="hidden" id="course_id" value="{{$previous[0]->course_id}}">
                        ...
                        <a href='{{$character}}/PastYear/FinalAssessment/name/download/zipFiles/{{$id}}---{{$previous[0]->course_id}}/All'><li class="sidebar-action-li"><i class="fa fa-download" style="padding: 0px 10px;" aria-hidden="true"></i>All Result</li></a>
                  </ul>
                </div>
                <br>
                <br>
                      ...
                      <div class="col-11" style="padding-left: 20px;">
                          <div class="form-group">
                              ...
                              <span class="tooltiptext">
                                ...
                                <span>1. Keyword in Each Final Assesment</span><br/>
                              </span>
                          </div>
                      </div>
                  </div>
                  <div class="row" id="assessments"  style="margin-top: -25px;">
                    ...
                    <div class="col-12 row align-self-center" id="course_list">
                      <div class="col-12 row align-self-center">
                        ...
                        <a href="{{$character}}/Moderator/PastYear/FinalAssessment/{{$id}}/list/{{$row->fx_id}}/" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">
