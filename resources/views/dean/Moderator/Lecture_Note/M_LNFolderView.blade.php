...
<div id="all">
    <div>
        ...
        <p class="pass_page">
            ...
            <a href="{{$character}}/Moderator/lectureNote/{{$course[0]->course_id}}">Lecture Note</a>/
            <?php
                ...
                while(isset($place[$i])!=""){
                  if($lecture_note->used_by!=""){
                    foreach($all_note as $all_row){
                      if(($lecture_note->used_by)==($all_row->ln_id)){
                        echo "<a href='{{$character}}/Moderator/lectureNote/folder/$place[$i]'>".$place_name[$i]." (".$all_row->semester_name.")</a>/";
                      }
                    }
                  }else{
                    echo "<a href='{{$character}}/Moderator/lectureNote/folder/$place[$i]'>".$place_name[$i]."</a>/";
                  }
                  $i++;
                }
            ?>
                        ...
                        <div class="col-12 row align-self-center" id="course_list">
                          ...
                          <div class="col-12 row align-self-center" id="course_list">
                            <div class="col-9 row align-self-center">
                              ...
                              <a href="{{$character}}/Moderator/images/lectureNote/{{$row->ln_id}}/{{$row->note}}" data-toggle="lightbox" data-gallery="example-gallery_student" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;" id="show_image_link" data-title="{{$row->note_name}} {{$semester_name}}">
                                <div class="col-1" style="position: relative;top: -2px;">
