              ...
              @if($row_group->ass_fx_type == $row->ass_fx_type)
                <div class="col-12 row align-self-center" id="course_list">
                    <div class="col-11 row align-self-center">
                      ...
                      <a href="{{$character}}/Moderator/images/final_assessment/{{$row->ass_fx_document}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-11 row" style="padding:10px 0px;margin-left:5px;color:#0d2f81;border:0px solid black;" id="show_image_link" data-title="{{$course[0]->semester_name}} : Final / {{$row_group->ass_fx_type}} /  {{$row->ass_fx_name}} <br> <a href='{{$character}}/Moderator/final_assessment/view/whole_paper/{{$row->course_id}}' class='full_question' target='_blank'>Whole paper</a>">
