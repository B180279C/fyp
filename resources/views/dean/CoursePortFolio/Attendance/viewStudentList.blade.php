...
<div id="all">
    <div>
        ...
        <p class="pass_page">
            ...
            <a href="{{$character}}/CourseList/Attendance/{{$course[0]->course_id}}">Attendance</a>/
                    ...
                    <table style="text-align: left;box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);margin-top: 5px;" id="table" class="table table-hover">
                        <thead>
                            ...
                            <?php
                                ...
                                if($status=="P"){ 
                                    $present = '<i class="fa fa-check correct" aria-hidden="true" style="padding-top:5px;"></i>';
                                }else if($status=="A"){
                                    $Absent = '<i class="fa fa-check correct" aria-hidden="true" style="padding-top:5px;"></i>';
                                }else if($status=="L"){
                                    $Late = '<i class="fa fa-check correct" aria-hidden="true" style="padding-top:5px;"></i>';
                                }
                            ?>
                                <tr>
                                    ...
                                    <td style='border-left:1px solid #d9d9d9;border-bottom: 1px solid #d9d9d9;text-align: center;'>{!!$present!!}</td>
                                    <td style='border-left:1px solid #d9d9d9;border-bottom: 1px solid #d9d9d9;text-align: center;'>{!!$Absent!!}</td>
                                    <td style='border-left:1px solid #d9d9d9;border-bottom: 1px solid #d9d9d9;text-align: center;'>{!!$Late!!}</td>
                                </tr>
                            <?php
