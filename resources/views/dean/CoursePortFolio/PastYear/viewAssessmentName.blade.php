...
function w3_close() {
  ...
  $(document).ready(function(){
    $(document).on('click', '#checkDownloadAction', function(){
      ...
      if(checkedValue!=""){
        ...
        if($('.search').val()!=""){
          window.location = "{{$character}}/PastYear/assessment/name/download/zipFiles/"+id+"/searchedWord";
        }else{
          window.location = "{{$character}}/PastYear/assessment/name/download/zipFiles/"+id+"/checked";
        }
      }else{
    ...
    $(document).on('click', '.download_button', function(){
      ...
      window.location = "{{$character}}/CourseList/PastYear/assessment/download/"+original_id+"-"+num[2];
    });
  });
  ...
  $(function () {
        ...
        if($('.search').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url: "{{$character}}/CourseList/PastYear/assessment/name/searchAssessmentName/",
                ...
                <div id="action_sidebar" class="w3-animate-right" style="display: none">
                  ...
                  <ul class="sidebar-action-ul">
                      ...
                      <input type="hidden" id="course_id" value="{{$previous[0]->course_id}}">
                        ...
                        <a href='{{$character}}/PastYear/assessment/name/download/zipFiles/{{$previous[0]->course_id}}/All'><li class="sidebar-action-li"><i class="fa fa-download" style="padding: 0px 10px;" aria-hidden="true"></i>All Result</li></a>
                  </ul>
                </div>
                <br>
                <br>
                  ...
                  <div class="row" id="assessments"  style="margin-top: -25px;">
                    ...
                    <div class="col-12 row align-self-center" id="course_list">
                      <div class="col-12 row align-self-center">
                        ...
                        <a href="{{$character}}/CourseList/PastYear/assessment/{{$id}}/list/{{$row->ass_id}}/" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">
