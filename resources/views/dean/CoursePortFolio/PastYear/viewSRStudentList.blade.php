...
<script type="text/javascript">
  ...
  $(document).on('click', '#checkDownloadAction', function(){
    ...
    if(checkedValue!=""){
      ...
      window.location = "{{$character}}/PastYear/sampleResult/download/zipFiles/"+id+"/checked";
    }else{
  ...
  $(function () {
    ...
    if($('.search').val()!=""){
      ...
      $.ajax({
          type:'POST',
          url: "{{$character}}/CourseList/PastYear/assessment/sampleResult/searchStudentList/",
...
<div id="all">
    <div>
        ...
        <p class="pass_page">
            ...
            <a href="{{$character}}/CourseList/PastYear/sampleResult/{{$course[0]->course_id}}/previous/{{$previous[0]->course_id}}/All">{{$previous[0]->semester_name}}</a>/
                ...
                <div id="action_sidebar" class="w3-animate-right" style="display: none;width: 250px;">
                    ...
                    <ul class="sidebar-action-ul">
                      ...
                      <p class="title_method">Download</p>
                        ...
                        <a href='{{$character}}/PastYear/sampleResult/download/zipFiles/{{$assessments->ass_id}}/All'><li class="sidebar-action-li"><i class="fa fa-download" style="padding: 0px 10px;" aria-hidden="true"></i>All Result</li></a>
                      @endif
                    </ul>
                </div>
                <br>
                ...
                <div id="student_list" class="row" style="margin-top: -15px;">
                  ...
                  <div class="row col-md-12" id="lecturer" style="margin:12px 0px 0px 0px;padding: 0px 0px 5px 0px;border-bottom:1px solid black;">
                    ...
                    <div class="row col-md-4 align-self-center" id="course_list" style="margin:0px 0px 5px 0px;">
                          ...
                          <a href='{{$character}}/CourseList/PastYear/sampleResult/{{$id}}/result/{{$lr_row->ar_stu_id}}' class="col-11 row align-self-center" id="show_image_link" style="margin-left:0px;border:0px solid black;">
