...
<script type="text/javascript">
  ...
  $(function () {
        ...
        if($('.search').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url:'/CourseList/lectureNote/searchFiles',
...
<div id="all">
    <div>
        ...
        <p class="pass_page">
            ...
            <a href="/CourseList/lectureNote/{{$course[0]->course_id}}">Lecture Note</a>/
            <?php
                ...
                while(isset($place[$i])!=""){
                  if($lecture_note->used_by!=""){
                    foreach($all_note as $all_row){
                      if(($lecture_note->used_by)==($all_row->ln_id)){
                        echo "<a href='/Moderator/lectureNote/folder/$place[$i]'>".$place_name[$i]." (".$all_row->semester_name.")</a>/";
                      }
                    }
                  }else{
                    echo "<a href='/Moderator/lectureNote/folder/$place[$i]'>".$place_name[$i]."</a>/";
                  }
                  $i++;
                }
            ?>
                      ...
                      @foreach($lecture_note_list as $row)
                        ...
                        <div class="col-12 row align-self-center" id="course_list">
                          <div class="col-12 row align-self-center">
                            ...
                            <a href="/Moderator/lectureNote/folder/{{$row->ln_id}}" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">
