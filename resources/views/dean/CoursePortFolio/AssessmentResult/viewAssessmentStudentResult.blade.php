...
<script type="text/javascript">
  ...
  $(function () {
    ...
    if($('.search').val()!=""){
      ...
      $.ajax({
          type:'POST',
          url: "/CourseList/AssessmentResult/searchAssessmentForm/",
              ...
              @foreach($assessments as $row)
                <div class="col-12 row align-self-center" id="course_list">
                    <div class="col-12 row align-self-center" style="padding-left: 20px;">
                      ...
                      <a href='/CourseList/AssessmentResult/studentResult/{{$row->ass_id}}/' class="col-11 row" style="padding:10px 0px;margin-left:0px;color:#0d2f81;border:0px solid black;" id="show_image_link">
