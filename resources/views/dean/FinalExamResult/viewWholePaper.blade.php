...
if(isset($string)){
?>
<img src="{{$character}}/PastYear/images/FinalResult/{{$string[0]}}-{{$row->document}}" width="600px" height="auto">
<?php
}else{
?>
<img src="{{$character}}/images/FinalResult/{{$row->document}}" width="600px" height="auto">
<?php
}
?>
<br>
