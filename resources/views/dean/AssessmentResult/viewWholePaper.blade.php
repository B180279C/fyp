...
if(isset($string)){
?>
<img src="{{$character}}/PastYear/images/AssessmentResult/{{$string[0]}}-{{$row->document}}" width="600px" height="auto">
<?php
}else{
?>
<img src="{{$character}}/images/AssessmentResult/{{$row->document}}" width="600px" height="auto">
<?php
}
?>
<br>
