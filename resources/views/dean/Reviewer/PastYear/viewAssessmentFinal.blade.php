...
function w3_close() {
  ...
  $(document).ready(function(){
    ...
    $(document).on('click', '.download_button', function(){
      ...
      window.location = "{{$character}}/Reviewer/PastYear/FinalAssessment/download/"+course_id+"-"+num[2];
    });
  ...
  $(function () {
        ...
        if($('.search').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url: "{{$character}}/Reviewer/PastYear/FinalAssessment/searchAssessment/",
        ...
        if($('.search_result').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url: "{{$character}}/Reviewer/PastYear/FinalSampleResult/searchAssessmentResult/",
              data:{value:value,course_id:course_id},
              success:function(data){
                  ...
                  <div class="row" id="results"  style="margin-top: -25px;">
                    ...
                    <div class="col-12 row align-self-center" id="course_list">
                      <div class="col-8 row align-self-center">
                        ...
                        <a href="{{$character}}/Reviewer/PastYear/FinalSampleResult/{{$course[0]->course_id}}/previous/{{$row->course_id}}/All" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">
                          <div class="col-1" style="position: relative;top: -2px;">
                            <img src="{{url('image/folder2.png')}}" width="25px" height="25px"/>
                          </div>
                          <div class="col-10" id="course_name">
