...
$(document).ready(function(){
  $('[data-toggle="lightbox"]').click(function(event) {
    ...
    $(document).on('click', '.download_button', function(){
          ...
          window.location = "{{$character}}/Reviewer/PastYear/AssessmentResult/result/"+course_id+"-"+num[2];
    });
  });
...
<div id="all">
    <div>
        ...
        <p class="pass_page">
            ...
            <a href="{{$character}}/Reviewer/PastYear/sampleResult/{{$id}}/previous/{{$course[0]->course_id}}/All">{{$course[0]->semester_name}}</a>/
            <a href="{{$character}}/Reviewer/PastYear/sampleResult/{{$id}}/name/{{$assessments->ass_id}}/All">{{$assessments->assessment_name}}</a>/
        ...
        <div class="col-md-12">
            ...
            @if(($ext[1] == "pdf")||($ext[1] == "docx")||($ext[1] == "xlsx")||($ext[1] == "pptx"))
                    ...
                    <div class="col-9 row align-self-center">
                      ...
                      <a href="{{$character}}/Reviewer/PastYear/AssessmentResult/result/{{$id}}-{{$row->ar_stu_id}}" class="col-11 row" style="padding:10px 0px;margin-left:5px;color:#0d2f81;border:0px solid black;" id="show_image_link">
            ...
            @else
                <div class="col-12 row align-self-center" id="course_list">
                  <div class="col-9 row align-self-center" >
                    ...
                    <a href="{{$character}}/Reviewer/PastYear/images/AssessmentResult/{{$id}}-{{$row->document}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-11 row" style="padding:10px 0px;margin-left:5px;color:#0d2f81;border:0px solid black;" id="show_image_link" data-title="{{$row->document_name}} <br> <a href='{{$character}}/Reviewer/PastYear/AssessmentResult/view/whole_paper/{{$id}}-{{$row->ar_stu_id}}' class='full_question' target='_blank'>Whole paper</a>">
                      <div class="col-1" style="position: relative;top: -2px;">
            ...
            @if(($ext[1] == "pdf")||($ext[1] == "docx")||($ext[1] == "xlsx")||($ext[1] == "pptx"))
		        <div class="row col-12 align-self-center" id="course_list">
                    <div class="col-9 row align-self-center">
                      ...
                      <a href="{{$character}}/Reviewer/PastYear/AssessmentResult/result/{{$id}}-{{$sow->ar_stu_id}}" class="col-11 row" style="padding:10px 0px;margin-left:5px;color:#0d2f81;border:0px solid black;" id="show_image_link">
                        <div class="col-1" style="position: relative;top: -2px;">
                          @if($ext[1]=="pdf")
                            <img src="{{url('image/pdf.png')}}" width="25px" height="25px"/>
                          @elseif($ext[1]=="docx")
            ...
            @else
                <div class="col-12 row align-self-center" id="course_list">
                  <div class="col-9 row align-self-center">
                    ...
                    <a href="{{$character}}/Reviewer/PastYear/images/AssessmentResult/{{$id}}-{{$sow->document}}" data-toggle="lightbox" data-gallery="example-gallery_student" class="col-11 row" style="padding:10px 0px;margin-left:5px;color:#0d2f81;border:0px solid black;" id="show_image_link" data-title="{{$sow->document_name}} <br> <a href='{{$character}}/Reviewer/PastYear/AssessmentResult/view/whole_paper/{{$id}}-{{$sow->ar_stu_id}}' class='full_question' target='_blank'>Whole paper</a>">
                      <div class="col-1" style="position: relative;top: -2px;">
                        <img src="{{url('image/img_icon.png')}}" width="25px" height="20px"/>
                      </div>
                      <div class="col-10" id="course_name">
