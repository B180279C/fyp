...
<script type="text/javascript">
  ...
  $(function () {
    ...
    if($('.search').val()!=""){
      ...
      $.ajax({
          type:'POST',
          url: "{{$character}}/Reviewer/PastYear/FinalSampleResult/searchStudentList/",
                ...
                <div id="student_list" class="row" style="margin-top: -15px;">
                  ...
                  <div class="row col-md-12" id="lecturer" style="margin:12px 0px 0px 0px;padding: 0px 0px 5px 0px;border-bottom:1px solid black;">
                    ...
                    <div class="row col-md-4 align-self-center" id="course_list" style="margin:0px 0px 5px 0px;">
                          ...
                          <a href='{{$character}}/Reviewer/PastYear/FinalSampleResult/{{$id}}/result/{{$lr_row->fxr_id}}' class="col-11 row align-self-center" id="show_image_link" style="margin-left:0px;border:0px solid black;">
