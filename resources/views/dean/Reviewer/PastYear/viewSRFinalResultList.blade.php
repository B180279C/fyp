...
$(document).ready(function(){
  $('[data-toggle="lightbox"]').click(function(event) {
    ...
    $(document).on('click', '.download_button', function(){
          ...
          window.location = "{{$character}}/Reviewer/PastYear/FinalSampleResult/download/"+original_id+"-"+num[2];
    });
  });
...
$(document).on('click', '#checkDownloadAction', function(){
  ...
  if(checkedValue!=""){
    ...
    var original_id = $('#original_id').val();
    var id = original_id+"_"+course_id+"_"+checkedValue;
...
<div id="all">
    <div>
        ...
        <p class="pass_page">
            ...
            <a href="{{$character}}/Reviewer/PastYear/FinalAssessment/{{$id}}">Final Assessment</a>/
            <a href="{{$character}}/Reviewer/PastYear/FinalSampleResult/{{$id}}/previous/{{$course[0]->course_id}}/All">{{$course[0]->semester_name}}</a>/
                ...
                <div id="action_sidebar" class="w3-animate-right" style="display: none;width: 250px;">
                    ...
                    <ul class="sidebar-action-ul">
                      ...
                      <input type="hidden" id="original_id" value="{{$id}}">
                        ...
                        <a href='{{$character}}/PastYear/FinalSampleResult/Student/{{$assessment_final_result->student_id}}/download/zipFiles/{{$id}}_{{$course[0]->course_id}}/All'><li class="sidebar-action-li"><i class="fa fa-download" style="padding: 0px 10px;" aria-hidden="true"></i>All Result</li></a>
                    </ul>
                </div>
            @endif
            ...
            @if(($ext[1] == "pdf")||($ext[1] == "docx")||($ext[1] == "xlsx")||($ext[1] == "pptx"))
                  <div class="col-12 row align-self-center" id="course_list">
                    <div class="col-9 row align-self-center">
                      ...
                      <a href="{{$character}}/Reviewer/PastYear/FinalSampleResult/download/{{$id}}-{{$row->fxr_id}}" class="col-11 row" style="padding:10px 0px;margin-left:5px;color:#0d2f81;border:0px solid black;" id="show_image_link">
            ...
            @else
                <div class="col-12 row align-self-center" id="course_list">
                  <div class="col-9 row align-self-center" >
                    ...
                    <a href="{{$character}}/Reviewer/PastYear/images/FinalResult/{{$id}}-{{$row->document}}" data-toggle="lightbox" data-gallery="example-gallery" class="col-11 row" style="padding:10px 0px;margin-left:5px;color:#0d2f81;border:0px solid black;" id="show_image_link" data-title="{{$row->document_name}} <br> <a href='{{$character}}/Reviewer/PastYear/FinalResult/view/whole_paper/{{$id}}-{{$row->fxr_id}}' class='full_question' target='_blank'>Whole paper</a>">
                      <div class="col-1" style="position: relative;top: -2px;">
        ...
        <div class="row col-md-12" id="student" style="margin:0px;padding:0px 0px 10px 0px;border-bottom:1px solid black;">
            ...
            <div class="row col-12 align-self-center" id="course_list">
                    <div class="col-9 row align-self-center">
                      ...
                      <a href="{{$character}}/Reviewer/PastYear/FinalSampleResult/download/{{$id}}-{{$sow->fxr_id}}" class="col-11 row" style="padding:10px 0px;margin-left:5px;color:#0d2f81;border:0px solid black;" id="show_image_link">
                        <div class="col-1" style="position: relative;top: -2px;">
                          @if($ext[1]=="pdf")
                            <img src="{{url('image/pdf.png')}}" width="25px" height="25px"/>
                          @elseif($ext[1]=="docx")
            ...
            @else
                <div class="col-12 row align-self-center" id="course_list">
                  <div class="col-9 row align-self-center">
                    ...
                    <a href="{{$character}}/Reviewer/PastYear/images/FinalResult/{{$id}}-{{$sow->document}}" data-toggle="lightbox" data-gallery="example-gallery_student" class="col-11 row" style="padding:10px 0px;margin-left:5px;color:#0d2f81;border:0px solid black;" id="show_image_link" data-title="{{$sow->document_name}} <br> <a href='{{$character}}/Reviewer/PastYear/AssessmentResult/view/whole_paper/{{$id}}-{{$sow->fxr_id}}' class='full_question' target='_blank'>Whole paper</a>">
                      <div class="col-1" style="position: relative;top: -2px;">
                        <img src="{{url('image/img_icon.png')}}" width="25px" height="20px"/>
                      </div>
                      <div class="col-10" id="course_name">
