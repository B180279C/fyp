...
<script type="text/javascript">
  ...
  $(function () {
        ...
        if($('.search').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url:'{{$character}}/Reviewer/PastYear/lectureNote/searchFiles',
                ...
                <div class="row" id="lecture_note" style="margin-top: -25px;">
                    ...
                    <div class="col-12 row align-self-center" id="course_list">
                      <div class="col-8 row align-self-center">
                        ...
                        <a href="{{$character}}/Reviewer/PastYearNote/{{$course[0]->course_id}}/course/{{$row->course_id}}/" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">
