...
if(isset($string)){
?>
<img src="{{$character}}/Reviewer/PastYear/images/AssessmentResult/{{$string[0]}}-{{$row->document}}" width="600px" height="auto">
<?php
}else{
?>
<img src="{{$character}}/Reviewer/images/AssessmentResult/{{$row->document}}" width="600px" height="auto">
<?php
}
?>
