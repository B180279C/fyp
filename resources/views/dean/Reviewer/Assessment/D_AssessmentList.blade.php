            ...
            <div style="overflow-x: auto;padding:3px 10px 5px 10px;display: none;" id="plan_detail_1">
                <table style="text-align: left;box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);padding: 0px;" id="table" class="table">
                  <thead>
                      ...
                      <tr style="background-color: #d9d9d9;">
                        @foreach($assessments as $row)
                          <th style="border-left:1px solid #e6e6e6;color:black;text-align: center;" width="{{50/count($assessments)}}%"><a href='{{$character}}/Reviewer/assessment/view/whole_paper/{{$row->ass_id}}' target='_blank' id="show_image_link" style="color:#0d2f81;">{{$row->assessment_name}}</a></th>
                        @endforeach
                      </tr>
                      <?php
                      $num = 1;
                  ...
                  <table style="text-align: left;box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);padding: 0px;" id="table" class="table">
                    <thead>
                      <tr style="background-color: #d9d9d9;">
                        ...
                        @foreach($assessments as $row)
                          <th style="border-left:1px solid #e6e6e6;color:black;text-align: center;" width="{{50/count($assessments)}}%" colspan="2"><a href='{{$character}}/Reviewer/assessment/view/whole_paper/{{$row->ass_id}}' target='_blank' id="show_image_link" style="color:#0d2f81;">{{$row->assessment_name}}</a></th>
                        @endforeach
                        <tr style="background-color: #d9d9d9;">
                ...
                <div style="overflow-x: auto;padding:3px 10px 5px 10px;display: none;" id="plan_detail_3">
                    ...
                    <div class="col-12" style="margin-top: 10px;border:0px solid black">
                           <a href='{{$character}}/Reviewer/assessment/view/whole_paper/{{$row->ass_id}}' target='_blank' id="show_image_link" style="color:#0d2f81;"> {{$row->assessment_name}} : </a>
                ...
                <div class="row" style="height: auto;margin: 5px -10px 10px -10px;">
                  <form id="myForm" method="post" action="{{$character}}/Reviewer/Assessment/approve/" style="width: 100%;margin: 0px;">
                      {{csrf_field()}}
