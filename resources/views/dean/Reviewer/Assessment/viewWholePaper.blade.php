...
if(isset($string)){
?>
<img src="{{$character}}/Reviewer/PastYear/images/assessment/{{$string[0]}}-{{$row->ass_document}}" width="600px" height="auto">
<?php
}else{
?>
<img src="{{$character}}/Reviewer/images/assessment/{{$row->ass_document}}" width="600px" height="auto">
<?php
}
?>
<br>
