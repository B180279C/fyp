...
<script type="text/javascript">
  ...
  $(document).ready(function(){  
    ...
    $(document).on('click', '.download_button', function(){
        var id = $(this).attr("id");
        var num = id.split("_");
        window.location = "{{$character}}/Reviewer/lectureNote/download/"+num[2];
    });
  });
  $(function () {
        $.ajaxSetup({
        ...
        if($('.search').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url:'{{$character}}/Reviewer/lectureNote/searchFiles',
...
<div id="all">
    <div>
        ...
        <p class="pass_page">
            ...
            <a href="{{$character}}/Reviewer/lectureNote/{{$course[0]->course_id}}">Lecture Note</a>/
            <?php
                ...
                while(isset($place[$i])!=""){
                  if($lecture_note->used_by!=""){
                    foreach($all_note as $all_row){
                      if(($lecture_note->used_by)==($all_row->ln_id)){
                        echo "<a href='{{$character}}/Reviewer/lectureNote/folder/$place[$i]'>".$place_name[$i]." (".$all_row->semester_name.")</a>/";
                      }
                    }
                  }else{
                    echo "<a href='{{$character}}/Reviewer/lectureNote/folder/$place[$i]'>".$place_name[$i]."</a>/";
                  }
                  $i++;
                }
            ?>
                    ...
                    <div class="col-11" style="padding-left: 20px;">
                        <div class="form-group">
                            ...
                            <span class="tooltiptext">
                              ...
                              <span>1. All Note in Current Semester</span><br/>
                            </span>
                        </div>
                    </div>
                </div>
                      ...
                      @foreach($lecture_note_list as $row)
                        ...
                        <div class="col-12 row align-self-center" id="course_list">
                          <div class="col-12 row align-self-center">
                            ...
                            <a href="{{$character}}/Reviewer/lectureNote/folder/{{$row->ln_id}}" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">
                        ...
                        <div class="col-12 row align-self-center" id="course_list">
                          <div class="col-12 row align-self-center">
                            ...
                            <a href="{{$character}}/Reviewer/lectureNote/download/{{$row->ln_id}}" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">
                              <div class="col-1" style="position: relative;top: -2px;">
                               @if($ext[1]=="pdf")
