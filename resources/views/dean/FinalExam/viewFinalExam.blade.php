      ...
      headers: {
        ...
        $.ajax({
            ...
            success:function(response){
              ...
              cell1.innerHTML = '<a href="{{$character}}/FinalExamination/list/'+percentage+'/'+course_id+'/" style="font-size:18px;width:100%;display:block;" class="question_link"><i class="fa fa-plus" aria-hidden="true" ></i></a>';
              if(status==true){
