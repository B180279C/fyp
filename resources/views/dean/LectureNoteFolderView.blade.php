...
<div id="all">
    <div>
        ...
        <p class="pass_page">
            ...
            <a href="/lectureNote/{{$course[0]->course_id}}">Lecture Note</a>/
            <?php
    ...
    <div class="row" style="padding: 10px 10px 10px 10px;">
        <div class="col-md-12">
             <p style="display: inline;font-size: 25px;position: relative;top: 5px;left: 10px;color: #0d2f81">{{$lecture_note->note_name}}</p>
