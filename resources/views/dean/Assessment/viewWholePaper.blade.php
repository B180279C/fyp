...
if(isset($string)){
?>
<img src="{{$character}}/PastYear/images/assessment/{{$string[0]}}-{{$row->ass_document}}" width="600px" height="auto">
<?php
}else{
?>
<img src="{{$character}}/images/assessment/{{$row->ass_document}}" width="600px" height="auto">
<?php
}
?>
