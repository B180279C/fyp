...
<script type="text/javascript">
      ...
      if(checkedValue!=""){
        ...
        var id = course_id+"---"+checkedValue;
          if($('.search').val()!=""){
            ...
            window.location = "{{$character}}/PastYearNote/download/zipFiles/"+id+"/checked";
          }
      }else{
  ...
  $(function () {
        ...
        if($('.search').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url:'{{$character}}/PastYear/lectureNote/searchFiles',
                ...
                <div id="action_sidebar" class="w3-animate-right" style="display: none">
                  ...
                  <ul class="sidebar-action-ul">
                      ...
                      <input type="hidden" id="course_id" value="{{$course[0]->course_id}}">
                        ...
                        <a href='{{$character}}/PastYearNote/download/zipFiles/{{$course[0]->course_id}}/All'><li class="sidebar-action-li"><i class="fa fa-download" style="padding: 0px 10px;" aria-hidden="true"></i>All Result</li></a>
                  </ul>
            </div>
            <br>
            <br>
                    ...
                    <div class="col-11" style="padding-left: 20px;">
                        <div class="form-group">
                            ...
                            <span class="tooltiptext">
                              ...
                              <span>1. All Note in all semester</span><br/>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="row" id="lecture_note" style="margin-top: -25px;">
                    ...
                    <div class="col-12 row align-self-center" id="course_list">
                      <div class="col-8 row align-self-center">
                        ...
                        <a href="{{$character}}/PastYearNote/{{$course[0]->course_id}}/course/{{$row->course_id}}/" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">
