...
<script type="text/javascript">
  ...
  $(document).on('click', '#checkDownloadAction', function(){
      ...
      if(checkedValue!=""){
        var id = checkedValue;
        window.location = "{{$character}}/report/TP/download/zipFiles/"+id+"/checked";
      }else{
...
$(function () {
    ...
    if($('.search').val()!=""){
        ...
        $.ajax({
            type:'POST',
            url:'{{$character}}/report/TP/searchCourse/',
            data:{value:value},
        ...
        <div class="col-md-12">
            ...
            <div class="details" style="padding: 0px 5px 0px 5px;">
              ...
              <div class="row" id="course" style="margin-top: -25px;">
                ...
                <?php
                    $status = App\Http\Controllers\Dean\ReportController::getTPaction($row->course_id);
                    if($status == "Rejected"){
                      $color = "red";
                ...
                <div class="col-12 row align-self-center" id="course_list">
                  <div class="col-10 row align-self-center" style="border:0px solid black;margin: 0px;">
                    ...
                    @if($status!="Pending")
                      <a href="{{$character}}/report/TP/view/{{$row->course_id}}" id="show_image_link" class="col-11 row" style="margin:0px;color:#0d2f81;border:0px solid black;width: 100%;">
                    @else
                    ...
                    @endif
                      <div class="col-1 align-self-center" id="course_image">
                        <img src="{{url('image/plan.png')}}" width="25px" height="25px"/>
                      </div>
                  ...
                  <div class="col-2 align-self-center" id="course_action">
                    <p style="padding:0px;margin:0px;color:<?php echo $color?>;">
                     <?php
                        echo App\Http\Controllers\Dean\ReportController::getTPaction($row->course_id);
                      ?>
                    </p>
                  </div>
                </div>
