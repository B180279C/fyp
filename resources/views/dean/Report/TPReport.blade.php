            ...
            <div style="overflow-x: auto;padding-bottom: 5px;">
              ...
              <tbody>
                 ...
                 <tr id="course_list" style="height: 50px;">
                  ...
                  <td width="3%" class='clickable-row {{$status}}' data-href='{{$character}}/report/TP/download/{{$row->course_id}}'>
                    <img src="{{url('image/docs.png')}}" width="25px" height="25px"/>
                  </td>
                  <td class='clickable-row {{$status}}' data-href='{{$character}}/report/TP/download/{{$row->course_id}}'>
