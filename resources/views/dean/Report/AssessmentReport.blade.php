...
$(function () {
    ...
    if($('.search').val()!=""){
        ...
        $.ajax({
            type:'POST',
            url:'{{$character}}/report/CA/searchCourse/',
            data:{value:value},
                    ...
                    <div class="col-11" style="padding-left: 20px;">
                        <div class="form-group">
                            ...
                            <span class="tooltiptext">
                              ...
                              <span>3. Lecturer Name</span><br/>
                            </span>
                        </div>
                    </div>
            </div>
            <div class="row" id="course" style="margin-top: -25px;">
                  <div class="col-12 row" style="padding: 0px 0px 5px 30px;margin:0px;">
                  ...
                  <?php
                    $status = App\Http\Controllers\Dean\ReportController::getCAaction($row->course_id);
                    if($status == "Rejected"){
                      $color = "red";
                ...
                <div class="col-12 row align-self-center" id="course_list">
                  <div class="col-10 row align-self-center" style="border:0px solid black;margin: 0px;">
                    ...
                    @if($status!="Pending"&&$status!="Waiting For Moderation")
                      <a href="{{$character}}/report/CA/view/{{$row->course_id}}" id="show_image_link" class="col-11 row" style="margin:0px;color:#0d2f81;border:0px solid black;width: 100%;">
                    @else
                    ...
                    @endif
                      <div class="col-1 align-self-center" id="course_image">
                        <img src="{{url('image/assessment.png')}}" width="25px" height="25px"/>
                      </div>
                  ...
                  <div class="col-2 align-self-center" id="course_action">
                    <p style="padding:0px;margin:0px;color:<?php echo $color?>;">
                     <?php
                        echo App\Http\Controllers\Dean\ReportController::getCAaction($row->course_id);
                      ?>
                    </p>
                  </div>
                </div>
