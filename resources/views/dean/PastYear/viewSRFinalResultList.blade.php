...
$(document).ready(function(){
    ...
    $(document).on('click', '.download_button', function(){
          var id = $(this).attr("id");
          var num = id.split("_");
          window.location = "/PastYear/FinalSampleResult/download/"+num[2];
    });
  });
...
$(document).on('click', '#checkDownloadAction', function(){
  ...
  if(checkedValue!=""){
    ...
    window.location = "/PastYear/FinalSampleResult/Student/"+student_id+"/download/zipFiles/"+id+"/checked";
  }else{
...
<div id="all">
    <div>
        ...
        <p class="pass_page">
            ...
            <a href="/PastYear/Final_Assessment/{{$id}}">Final Assessment</a>/
            <a href="/PastYear/FinalSampleResult/{{$id}}/previous/{{$course[0]->course_id}}/All">{{$course[0]->semester_name}}</a>/
                ...
                <div id="action_sidebar" class="w3-animate-right" style="display: none;width: 250px;">
                    ...
                    <ul class="sidebar-action-ul">
                      ...
                      <input type="hidden" id="student_id" value="{{$assessment_final_result->student_id}}">
                        ...
                        <a href='/PastYear/FinalSampleResult/Student/{{$assessment_final_result->student_id}}/download/zipFiles/{{$course[0]->course_id}}/All'><li class="sidebar-action-li"><i class="fa fa-download" style="padding: 0px 10px;" aria-hidden="true"></i>All Result</li></a>
                    </ul>
                </div>
            @endif
