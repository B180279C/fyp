...
function w3_close() {
  ...
  $(function () {
        ...
        if($('.search').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url: "/PastYear/assessment/searchAssessment/",
        ...
        if($('.search_result').val()!=""){
          ...
          $.ajax({
              type:'POST',
              url: "/PastYear/result/searchAssessmentResult/",
              data:{value:value,course_id:course_id},
              success:function(data){
                ...
                <div id="action_sidebar" class="w3-animate-right" style="display: none">
                  ...
                  <ul class="sidebar-action-ul">
                      ...
                      <input type="hidden" id="course_id" value="{{$course[0]->course_id}}">
                        ...
                        <a href='/PastYear/assessment/download/zipFiles/{{$course[0]->course_id}}/All'><li class="sidebar-action-li"><i class="fa fa-download" style="padding: 0px 10px;" aria-hidden="true"></i>All Result</li></a>
                  </ul>
                </div>
                <br>
                <br>
