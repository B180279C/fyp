...
<script type="text/javascript">
  ...
  $(document).on('click', '#checkDownloadAction', function(){
    ...
    if(checkedValue!=""){
      ...
      window.location = "/PastYear/FinalSampleResult/student/download/zipFiles/"+id+"/checked";
    }else{
  ...
  $(function () {
    ...
    if($('.search').val()!=""){
      ...
      $.ajax({
          type:'POST',
          url: "/PastYear/FinalSampleResult/searchStudentList/",
          data:{value:value,course_id:course_id,id:id},
                ...
                <div id="action_sidebar" class="w3-animate-right" style="display: none;width: 250px;">
                    ...
                    <ul class="sidebar-action-ul">
                      ...
                      <p class="title_method">Download</p>
                        ...
                        <a href='/PastYear/FinalSampleResult/download/zipFiles/{{$previous[0]->course_id}}/All'><li class="sidebar-action-li"><i class="fa fa-download" style="padding: 0px 10px;" aria-hidden="true"></i>All Result</li></a>
                      @endif
                    </ul>
                </div>
                <br>
                ...
                <div class="col-md-6 row" style="padding:0px 20px;position: relative;top: -25px;">
                    ...
                    <div class="col-11" style="padding-left: 20px;">
                        <div class="form-group">
                            ...
                            <input type="hidden" value="{{$id}}" id="original_id">
                            <input type="hidden" value="{{$previous[0]->course_id}}" id="course_id">
                            @if($search=="All")
                ...
                <div id="student_list" class="row" style="margin-top: -15px;">
                  ...
                  <div class="row col-md-12" id="lecturer" style="margin:12px 0px 0px 0px;padding: 0px 0px 5px 0px;border-bottom:1px solid black;">
                    ...
                    <div class="row col-md-4 align-self-center" id="course_list" style="margin:0px 0px 5px 0px;">
                          ...
                          <a href='/PastYear/FinalSampleResult/{{$id}}/result/{{$lr_row->fxr_id}}' class="col-11 row align-self-center" id="show_image_link" style="margin-left:0px;border:0px solid black;">
