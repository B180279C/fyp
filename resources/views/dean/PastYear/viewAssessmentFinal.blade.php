                  ...
                  <div class="row" id="assessments"  style="margin-top: -25px;">
                    ...
                    <div class="col-12 row align-self-center" id="course_list">
                      <div class="col-8 row align-self-center">
                        ...
                        <a href="{{$character}}/PastYear/FinalAssessment/{{$course[0]->course_id}}/list/{{$row->course_id}}" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">
