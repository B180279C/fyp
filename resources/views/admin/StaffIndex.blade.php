...
<script type="text/javascript">
    ...
    $(document).on('click', '.remove_action', function(){
        ...
        if(confirm('Are you sure want to remove it')){
          window.location = "/staff/remove/"+num[2];
        }
        return false;
    });
        ...
        <div class="col-md-12">
            ...
            <div id="action_sidebar" class="w3-animate-right" style="display: none">
              ...
              <ul class="sidebar-action-ul">
                  ...
                  <a href="/staff/excel/download/"><li class="sidebar-action-li"><i class="fa fa-file-excel-o" style="padding: 0px 10px;" aria-hidden="true"></i>Export Excel File</li></a>
              </ul>
            </div>
            <br>
                ...
                <table style="text-align: left;box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);border:none;" id="dtBasicExample">
                    <thead style="background-color: #0d2f81!important;">
                        <tr style="background-color: #d9d9d9;">
                            ...
                            <th style="border-left:1px solid #e6e6e6;border-bottom: 1px solid #d9d9d9;text-align: center;">Staff Id</th>
                            <th style="border-left:1px solid #e6e6e6;border-bottom: 1px solid #d9d9d9;text-align: center;">Position</th>
                    ...
                    <tbody>
                        ...
                        <tr style="height: 60px;">
                            ...
                            <td style="border-left:1px solid #d9d9d9;border-bottom: 1px solid #d9d9d9;text-align: left;">{{$row->staff_id}}</td>
                            <td style="border-left:1px solid #d9d9d9;border-bottom: 1px solid #d9d9d9;text-align: left;">{{$row->position}} , {{$row->department_name}}</td>
                            ...
                            <!-- <td style="border-left:1px solid #d9d9d9;border-bottom: 1px solid #d9d9d9;text-align: center;">
                                <a href="{{action('StaffController@edit', $row->staff_id)}}">Edit</a>
                            </td> -->
                            <td style="border-left:1px solid #d9d9d9;border-bottom: 1px solid #d9d9d9;text-align: center;">
                                <i class="fa fa-wrench edit_action" aria-hidden="true" id="edit_button_{{$row->staff_id}}" style="border: 1px solid #cccccc;padding:5px;border-radius: 50%;color:green;background-color: white;width: 28px;"></i>&nbsp;
                                <i class="fa fa-times remove_action" aria-hidden="true" id="remove_button_{{$row->staff_id}}" style="border: 1px solid #cccccc;padding:5px;border-radius: 50%;color:red;background-color: white;width: 28px;text-align: center;"></i>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
