      ...
      <p class="page_title" style="position: relative;left: 0px ;">Add Subject Information</p>
            <button onclick="w3_open()" class="button_open" id="button_open" style="float: right;margin-top: 5px;"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></button>
                <div id="action_sidebar" class="w3-animate-right" style="display: none;margin-right: 0px;width: 200px;">
                  ...
                  <ul class="sidebar-action-ul">
                      <a href="/subject/excel/download/{{$id}}"><li class="sidebar-action-li"><i class="fa fa-download" style="padding: 0px 10px;" aria-hidden="true"></i>Export Excel File</li></a>     
                  </ul>
                </div>
      </div>
    </div>
        <div class="details" style="padding:0px 20px">
            <hr style="margin: 5px 0px 0px 0px;">
                    ...
                    @endif
                        <form method="post" action="{{action('SubjectController@store', $id)}}">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-11" style="padding-left: 20px;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="programme_name" value="{{$programme->programme_name}}" class="form-control" id="input" readonly style="font-weight: bold;">
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        @foreach($group as $row_group)
                            <div id="dynamic_field<?php echo $i?>">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-2 align-self-center" style="padding: 25px 0px 0px 5px;">
                                ...
                                @foreach($subjects as $row)
                                  ...
                                  <div class="row list_row" style="margin-bottom: 10px;">
                                    <div class="col-md-1 align-self-center"></div>
                                    <div class="col-md-2 align-self-center" style="padding: 0px;">
                                      ...
                                      <div class="col-md-9 row align-self-center">
                                          ...
                                          <div class="col-md-2 align-self-center" style="padding: 20px 0px 0px 5px;">
                                            <a class="btn btn-raised btn-primary open-modal " id="{{$row->subject_id}}"><i class="fa fa-pencil" aria-hidden="true" style="color:white;"></i>
                                            </a>
                                          </div>
                                      </div>
                                  </div>
...
<div class="modal fade bd-example-modal-lg" id="subjectTypeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="color: #0d2f81;">Edit Subject Information</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" action="{{action('SubjectController@subjectTypeUpdateModal')}}">
        {{csrf_field()}}
      <div class="modal-body">
