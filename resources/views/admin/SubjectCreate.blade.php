...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="card">
                <div class="card-header">{{ __('Add Subject Information') }}</div>
                <div class="card-body">
                    @if(count($errors) > 0)
                                  ...
                                  <div class="form-group row list_row">
                                      ...
                                      <div class="col-md-8 row">
                                          ...
                                          <div class="col-md-1" style="padding: 1px">
                                            <a class="btn btn-secondary open-modal " id="{{$row->subject_id}}"><i class="fa fa-pencil" aria-hidden="true" style="color:white;"></i>
                                            </a>
                                          </div>
                                      </div>
                                  </div>
