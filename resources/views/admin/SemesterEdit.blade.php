...
<div id="all">
    <div>
        <p style="margin: 0px;padding:10px 20px;font-size: 30px;">Edit Semester</p>
        <p class="pass_page">
            <a href="/home" class="first_page"> Home </a>/
            <a href="/semester_list">Semester </a>/
            <span class="now_page">Edit Semester</span>/
        </p>
        <hr class="separate_hr">
    </div>
    <div class="col-md-12">
        <div class="details" style="padding: 10px 0px 5px 0px;">
            <p class="page_title" style="position: relative;left: 5px;">Edit Semester Information</p>
            <hr style="margin: 0px;">
                    @if(count($errors) > 0)
                    ...
                    @endif
                        <form method="post" action="{{action('SemesterController@update', $id)}}">
                        {{csrf_field()}}
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" name="year" id="year" data-width="100%" title="Choose One" required>
                                            <option <?php if($semester->year==(date('y')-5)){ echo "selected";}?> value="<?php echo date('y')-5?>" class="option"><?php echo date('Y')-5?></option>
                                                <option <?php if($semester->year==(date('y')-4)){ echo "selected";}?> value="<?php echo date('y')-4?>" class="option"><?php echo date('Y')-4?></option>
                            ...
                            <div class="col">
                                <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" name="semester" id="programme" data-width="100%" title="Choose One" required>
                                                <option <?php if($semester->semester=="A"){ echo "selected";}?> value="A" class="option">Semester 1</option>
                                                <option <?php if($semester->semester=="B"){ echo "selected";}?> value="B" class="option">Semester 2</option>
                                                <option <?php if($semester->semester=="C"){ echo "selected";}?> value="C" class="option">Semester 3</option>
                                        </select>
                                    </div>
                                </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="start_date" value="{{$semester->startDate}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="end_date" value="{{$semester->endDate}}">
                                </div>
                            </div>
                        </div>
                        <hr>
