...
<script type="text/javascript">
    ...
    $(document).on('click', '.remove_action', function(){
        ...
        if(confirm('Are you sure want to remove it')){
          window.location = "/courses/remove/"+num[2];
        }
        return false;
    });
...
<div id="all">
    <div>
        <p style="margin: 0px;padding:10px 20px;font-size: 30px;">Courses Listing</p>
        <p class="pass_page">
            ...
            <div style="overflow-x:auto;">
                ...
                <tbody>
                    ...
                    <tr style="height: 60px;">
                        ...
                        <td style="border-left:1px solid #d9d9d9;border-bottom: 1px solid #d9d9d9;text-align: left;">{{$row->semester_name}}</b> : {{$row->short_form_name}} / {{$row->subject_code}} {{$row->subject_name}} ( {{$row->name}} )</td>
...
<div class="modal fade bd-example-modal-lg" id="openDocumentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="{{route('admin.dropzone.uploadCourses')}}" enctype="multipart/form-data"
