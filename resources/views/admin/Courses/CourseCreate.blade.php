...
<div id="all">
    <div>
        <p style="margin: 0px;padding:10px 20px;font-size: 30px;">Create new Course</p>
        <p class="pass_page">
        ...
        <div class="details" style="padding: 10px 0px 5px 0px;">
            ...
            <hr style="margin: 0px;">
                    ...
                    <div id="error-message"></div>
                        <form method="post" action="/admin/courses/create/" id="myForm">
                        {{csrf_field()}}
                        <div class="row">
                        ...
                        <div class="row" id="form_lct" style="margin-top:0px;">
                            <div class="col-1 align-self-center" style="padding: 15px 0px 0px 2%;">
                                <p class="text-center align-self-center" style="margin: 0px;padding:0px;font-size: 20px;width: 30px!important;border-radius: 50%;background-color: #0d2f81;color: gold;">
