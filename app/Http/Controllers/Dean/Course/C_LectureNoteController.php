...
class C_LectureNoteController extends Controller
{
    public function LectureNote($id)
    {
        ...
        if(count($course)>0){
            return view('dean.CoursePortfolio.Lecture_Note.C_Lecture_note',compact('course','lecture_note','all_note'));
        }else{
    ...
    public function LNFolderView($folder_id)
    {
        ...
        if(count($course)>0){
            return view('dean.CoursePortfolio.Lecture_Note.C_LNFolderView', compact('course','note_place','lecture_note','lecture_note_list','all_note','data'));
        }else{
            return redirect()->back();
        }
    }
