...
class C_AssessmentResultController extends Controller
{
    public function viewAssessmentStudentResult($id,$question)
    {
        ...
        if((count($course)>0)&&(count($assessments)>0)){
            return view('dean.CoursePortFolio.AssessmentResult.viewAssessmentStudentResult',compact('course','question','assessments'));
        }else{
    ...
    public function viewstudentlist($ass_id)
    {
        ...
        if(count($course)>0){
            return view('dean.CoursePortFolio.AssessmentResult.viewStudentResult',compact('course','assessments','lecturer_result','student_result'));
        }else{
            return redirect()->back();
        }
    }
    ...
    public function viewStudentResult($ar_stu_id)
    {
        ...
        if(count($course)>0){
            return view('dean.CoursePortFolio.AssessmentResult.viewResultList',compact('course','assessments','assessment_result_student','lecturer_result','student_result'));
        }else{
            return redirect()->back();
        }
    }
