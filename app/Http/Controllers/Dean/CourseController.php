...
class CourseController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('dean.CoursePortFolio.CourseEdit', compact('programme', 'staffs','lct','faculty','faculty_name','semester','group','subjects','course','count_staff_InFaculty','moderator', 'id','reviewer','timetable'));
    }
