...
class D_PastYearController extends Controller
{
    public function PastYearAssessment($id)
    {
        ...
        if(count($course)>0){
            return view('dean.Reviewer.PastYear.viewAssessment',compact('course','previous_semester'));
        }else{
        ...
        if($value!=""){
        	$data_name = DB::table('assessments')
           	...
           	if(count($data_name)>0) {
           		...
           		foreach($data_name as $ass_row_name){
	                ...
	                $result .= '</div>';
	                $result .= '<a href="'.$character.'/Reviewer/PastYear/assessment/'.$course_id.'/list/'.$ass_row_name->ass_id.'/" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
        	...
        	$previous_semester = DB::table('courses')
           	...
           	foreach($previous_semester as $row){
	            ...
	            $result .= '</div>';
	            $result .= '<a href="'.$character.'/Reviewer/PastYear/assessment/'.$course_id.'/assessment_name/'.$row->course_id.'" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
	            $result .= '<div class="col-1" style="position: relative;top: -2px;">';
    ...
    public function searchAssessmentName(Request $request)
    {
        ...
        if($value!=""){
            ...
            foreach($assessments as $row){
	            ...
	            $result .= '</div>';
	            $result .= '<a href="'.$character.'/Reviewer/PastYear/assessment/'.$original_id.'/list/'.$row->ass_id.'/" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
	            $result .= '<div class="col-1" style="position: relative;top: -2px;">';
	            $result .= '<img src="'.url('image/file.png').'" width="20px" height="25px"/>';
	            $result .= '</div>';
	            $result .= '<div class="col-10" id="assessment_name">';
    ...
    public function PastYearAssessmentList($id,$ass_id)
    {
        ...
        if(count($course)>0){
            return view('dean.Reviewer.PastYear.viewAssessmentList',compact('course','assessments','previous','assessment_list','group_list'));
        }else{
            return redirect()->back();
        }
    }
    ...
    public function searchAssessmentResult(Request $request)
    {
        ...
        if($value!=""){
        	$data_name = DB::table('assessments')
           	...
           	if(count($data_name)>0) {
           		...
           		foreach($data_name as $ass_row_name){
	                ...
	                $result .= '</div>';
	                $result .= '<a href="'.$character.'/Reviewer/PastYear/sampleResult/'.$course_id.'/name/'.$ass_row_name->ass_id.'/All" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
	                $result .= '<div class="col-1" style="position: relative;top: -2px;">';
	                $result .= '<img src="'.url('image/file.png').'" width="20px" height="25px"/>';
	                $result .= '</div>';
	                $result .= '<div class="col-10" id="assessment_name">';
			    ...
			    if(count($batch_list)>0) {
				    ...
				    foreach($batch_list as $rs_row){
		                ...
		                $result .= '</div>';
		                $result .= '<a href="'.$character.'/Reviewer/PastYear/sampleResult/'.$course_id.'/previous/'.$rs_row->course_id.'/'.$rs_row->batch.'/" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
		                $result .= '<div class="col-1" style="position: relative;top: -2px;">';
		                $result .= '<img src="'.url('image/folder2.png').'" width="25px" height="25px"/>';
		                $result .= '</div>';
		                $result .= '<div class="col-10" id="course_name">';
				    ...
				    if(count($student_list)>0) {
					    ...
					    foreach($student_list as $stu_row){
			                ...
			                $result .= '</div>';
			                $result .= '<a href="'.$character.'/Reviewer/PastYear/sampleResult/'.$course_id.'/previous/'.$stu_row->course_id.'/'.$stu_row->student_id.'/" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
			                $result .= '<div class="col-1" style="position: relative;top: -2px;">';
			                $result .= '<img src="'.url('image/folder2.png').'" width="25px" height="25px"/>';
			                $result .= '</div>';
			                $result .= '<div class="col-10" id="course_name">';
				        ...
				        if(count($submitted_list)>0){
					    	...
					    	foreach($submitted_list as $sub_row){
				                ...
				                $result .= '</div>';
				                $result .= '<a href="'.$character.'/Reviewer/PastYear/sampleResult/'.$course_id.'/previous/'.$sub_row->course_id.'/'.$sub_row->submitted_by.'/" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
				                $result .= '<div class="col-1" style="position: relative;top: -2px;">';
				                $result .= '<img src="'.url('image/folder2.png').'" width="25px" height="25px"/>';
				                $result .= '</div>';
				                $result .= '<div class="col-10" id="course_name">';
            ...
            foreach($previous_semester as $row){
	            ...
	            $result .= '</div>';
	            $result .= '<a href="'.$character.'/Reviewer/PastYear/sampleResult/'.$course_id.'/previous/'.$row->course_id.'/All" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
	            $result .= '<div class="col-1" style="position: relative;top: -2px;">';
	            $result .= '<img src="'.url('image/folder2.png').'" width="25px" height="25px"/>';
	            $result .= '</div>';
	            $result .= '<div class="col-10" id="course_name">';
    ...
    public function searchAssessmentSampleResult(Request $request)
    {
        ...
        if($value!=""){
			    ...
			    if(count($student_list)>0){
			        ...
			        if(count($submitted_list)>0){
					    ...
					    foreach($submitted_list as $row){
				            ...
				            $result .= '<input type="checkbox" value="'.$row->ar_stu_id.'" class="group_download">';
				            $result .= '</div>';
				            $result .= '<a href="'.$character.'/Reviewer/PastYear/sampleResult/'.$original_id.'/name/'.$row->ass_id.'/'.$row->submitted_by.'" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
				            $result .= '<div class="col-1" style="position: relative;top: -2px;">';
				            $result .= '<img src="'.url('image/file.png').'" width="20px" height="25px"/>';
				            $result .= '</div>';
				            $result .= '<div class="col-10" id="assessment_name">';
            ...
            foreach($assessments as $row){
		            ...
		            $result .= '<input type="checkbox" value="'.$row->ass_id.'" class="group_download">';
		            $result .= '</div>';
		            $result .= '<a href="'.$character.'/Reviewer/PastYear/sampleResult/'.$original_id.'/name/'.$row->ass_id.'/All" id="show_image_link" class="col-11 row" style="padding:10px 0px;margin-left:-10px;color:#0d2f81;border:0px solid black;">';
		            $result .= '<div class="col-1" style="position: relative;top: -2px;">';
		            $result .= '<img src="'.url('image/file.png').'" width="20px" height="25px"/>';
		            $result .= '</div>';
		            $result .= '<div class="col-10" id="assessment_name">';
    ...
    public function PastYearStudentList($id,$ass_id,$search)
    {
        ...
        if(count($course)>0){
            return view('dean.Reviewer.PastYear.viewSRStudentList',compact('search','id','course','lecturer_result','student_result','assessments','previous'));
        }else{
            return redirect()->back();
        }
    }
        ...
        if($value!=""){
            ...
            if(count($result_list)>0) {
                ...
                foreach($result_list as $row){
                    ...
                    $result .= '</div>';
                    $result .= '<a href="'.$character.'/Reviewer/PastYear/sampleResult/'.$course_id.'/result/'.$row->ar_stu_id.'" class="col-11 row align-self-center" id="show_image_link" style="margin-left:0px;border:0px solid black;">';
            ...
            if(count($student_result)>0) {
                ...
                foreach($student_result as $sow){
                    ...
                    $result .= '</div>';
                    $result .= '<a href="'.$character.'/Reviewer/PastYear/sampleResult/'.$course_id.'/result/'.$sow->ar_stu_id.'" class="col-11 row align-self-center" id="show_image_link" style="margin-left:0px;border:0px solid black;">';
                    $result .= '<div class="col-12 row" style="padding:10px 10px 10px 0px;color:#0d2f81;">';
                    $result .= '<div class="col-1" style="position: relative;top: -2px;padding-left: 2px;">';
                    $result .= '<img src="'.url('image/folder2.png').'" width="25px" height="25px"/>';
                    $result .= '</div>';
    ...
    public function PastYearResultList($id,$ar_stu_id)
    {
        ...
        if(count($check_course)>0){
            return view('dean.Reviewer.PastYear.viewSRResultList',compact('id','course','assessments','assessment_result_student','lecturer_result','student_result'));
        }else{
            return redirect()->back();
        }
    }
    ...
    public function view_wholePaper($ass_id)
    {
        ...
        if(count($course)>0){
            return view('dean.Reviewer.Assessment.viewWholePaper', compact('assessments','assessment_list','question','string'));
        }else{
            return redirect()->back();
        }
    }
    ...
    public function view_wholePaperResult($ar_stu_id)
    {
        ...
        $assessment_result_list = DB::table('assessment_result_students')
                                ...
                                ->get();
        if(count($course)>0){
            return view('dean.Reviewer.AssessmentResult.viewWholePaper', compact('assessment_result_list','assessments','checkARID','submitted_by','string'));
        }else{
            return redirect()->back();
        }
    }
