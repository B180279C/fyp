...
class D_AttendanceController extends Controller
{
    public function viewAttendance($id)
    {
        ...
        if(count($course)>0){
            return view('dean.Reviewer.Attendance.viewAttendance',compact('course','timetable','attendance','id','average','completed','count_student'));
        }else{
    ...
    public function viewStudentList($id,$date)
    {
        ...
        if(count($course)>0){
            return view('dean.Reviewer.Attendance.viewStudentList',compact('course','tt_id','assign_student','date','timetable','attendance','week','fill_up'));
        }else{
            return redirect()->back();
        }
    }
