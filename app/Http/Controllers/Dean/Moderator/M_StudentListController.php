...
class M_StudentListController extends Controller
{
	public function ModeratorStudent($id)
	{
        ...
        $assign_student = DB::table('assign_student_course')
                    ...
                    ->get();
        if(count($course)>0){
            return view('dean.Moderator.Student_List.M_StudentList',compact('course','id','batch','assign_student'));
        }else{
            return redirect()->back();
        }
	}

	public function searchModeratorStudent(Request $request)
	{
