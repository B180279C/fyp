...
class M_FinalExamResultController extends Controller
{
    public function viewFinalResult($id)
    {
        ...
        if(count($course)>0){
            return view('dean.Moderator.FinalExamResult.viewFinalResult',compact('course','lecturer_result','student_result'));
        }else{
    ...
    public function viewFinalStudentResult($fxr_id)
    {
        ...
        if(count($course)>0){
            return view('dean.Moderator.FinalExamResult.viewResultList',compact('course','assessment_final_result','lecturer_result','student_result'));
        }else{
            return redirect()->back();
        }
    }
